...
print("¿Mi edad es mayor que 18? (<):", resultado3)
...
# NOT (no): Invierta el valor: True se cuelva False y viceversa
...
print("lista1 es lista3? (is):", lista1 is lista3) # True (mismo obejeto)
